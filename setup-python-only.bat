...
REM Ensure we are running from the directory containing this script so that
REM relative paths (like the boogpp package) resolve correctly even when the
REM script is launched from another location.
pushd "%~dp0" >nul
