# Boogpp Language Specification v1.0

## Overview
Boogpp is a Windows-centric systems programming language that combines Python-like syntax with C++ performance, compiled to native machine code via LLVM.
...
@service(
    ...
    start_type: AUTO,
    run_as: SYSTEM,
    description: "Boogpp background service"
)
...
var name = "Boogpp"    # Inferred as string
```
...
This specification provides the foundation for Boogpp. Implementation details and runtime behavior are defined in the compiler and runtime documentation.
